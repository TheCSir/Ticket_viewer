...
class UnitTests(unittest.TestCase):
    ...
    def test_single_ticket_url(self):
        self.assertEqual(ApiQuery().get_selected_ticket(1),
    ...
    def test_ticket_factory(self):
        ...
        "priority":5, "status":6,"recipient":7,"requester_id":8, ' \
                       '"assignee_id":9,\
        "created_at":"1111-11-11T11:11:11Z", ' \
                       '"updated_at":"2222-11-11T11:11:11Z",' \
                       '"due_at":"3333-11-11T11:11:11Z" }'
